...
namespace DZ {
    public partial class StandartSearchInFile : Form {
        private List<string> _gotText = new List<string>();

        private Stopwatch _watch = new Stopwatch();

        public StandartSearchInFile() {
            InitializeComponent();
...
//-----------------------------------------------------------------------------------
        ...
        private void StandartSearchInFile_Load(object sender, EventArgs e) {
            Owner.Visible = false;
        }

        private void StandartSearchInFile_FormClosed(object sender, FormClosedEventArgs e) {
            Owner.Visible = true;
        }
